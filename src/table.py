...
class Table:
    ...
    def __init__(self, capacity=4):
        ...
        self.table_df = pd.DataFrame({f'Table': [None] * capacity for i in range(1, self.capacity + 1)},
                                     index=range(1, self.capacity + 1))
  

    def __str__(self):
        # allow to get human readdbale output when printing the object
        return f"This is on of the table fitted in the room. it has {self.capacity} chairs"
